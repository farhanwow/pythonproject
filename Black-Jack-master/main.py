...
def bet():
    ...
    screen.blit(label, (150, 350))
    updateChips()
    pygame.display.update()
    while True:
        label = smallFont.render('Press space when finished', 1, (155, 155, 155))
        screen.blit(label, (750, 600))
        updateChips()
        pygame.display.update()
        ev = pygame.event.poll()
...
def firstStart():
    ...
    screen.blit(label2, (150, 350))
    screen.blit(label, (150, 400))
    pygame.display.update()
    pygame.init()
...
def updateScore(turn=False):
    ...
    screen.blit(score2, (720, 480))
    if turn:
        screen.blit(score1, (720, 20))
